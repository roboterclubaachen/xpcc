/* This is an Example application for a STM32F4 in combination with a Decawave DM1000 Chip
 ...
 * 1) Send a broadcast message to all nearby UWB receivers configured with the same Parameters every Second (Green LED)
*/
...
main()
{
	...
	while (true) //-----------MAINLOOP--------------
	{
		...
		dwm::send(3,buffer); // send frame over DW1000
